...
$validator = new App\Core\AccountValidation(new DayValidator(), new HourValidator(), new SingleValidator());
...
if ($input === 'deposit') {
    $accountController = new App\Controller\AccountController($view, $repository, $entityManager, $validator);
